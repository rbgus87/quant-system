...
# 장 마감 후 키움 모의 API가 결제 처리 중 일시적으로 빈 응답을 반환한다.
# 재시도 간격: 60 → 120 → 300초 (합계 ~8분). 210초(구 3.5분)로 부족한 경우 대응.
_DAILY_REPORT_RETRY_DELAYS_SEC = (60, 120, 300)
...
def run_daily_report() -> None:
    ...
    방어:
      - 잔고 API 0원 응답 시 60초/120초/300초 간격으로 최대 3회 재시도
